function [data]=scr_denoise_spike(inputdata, header, kbdata, cutoff)
% scr_denoise_spike removes noise from spike type 4 trigger channels
%
% FORMAT:
% [data]=scr_denoise_spike(inputdata, header, kbdata)
%
%__________________________________________________________________________
% PsPM 3.0
% (C) 2008-2015 Dominik R Bach (Wellcome Trust Centre for Neuroimaging)

% $Id: scr_denoise_spike.m 701 2015-01-22 14:36:13Z tmoser $
% $Rev: 701 $
