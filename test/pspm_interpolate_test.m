...
% $Id: pspm_interpolate_test.m 377 2016-10-31 15:57:10Z tmoser $
% $Rev: 377 $
    ...
    methods (Test)
        function invalid_input(this)
            ...
            options.channels = cell(size(valid_data)+1);
        ...
        function test_datatypes(this, datatype, amount, chans)
            ...
            % * not interpolated channels (specified by options.channels)
            ...
            if iscell(outdata)
                for i=1:numel(outdata)
                    ...
                    if strcmpi(datatype, 'file')
                        ...
                        if iscell(options.channels) && numel(options.channels) > 0
                            check_chans = options.channels{i};
                        else
                            check_chans = {};
                        end;
                    end;
        ...
        function test_no_nan(this)
            ...
            this.verifyEqual(data.data, outdata.data);
