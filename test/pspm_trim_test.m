classdef pspm_trim_test < matlab.unittest.TestCase
    ...
    methods (TestClassSetup)
        function gen_testdata(testCase)
            ...
            % testCase.sr = 100;
            % These variables seem to be a fixed value, should be a global
            % constant then (Teddy 19-07-2021)
    ...
    methods (Test)
        ...
        function multiple_files(testCase)
            ...
            delete(testCase.fn2);
            % with struct input
            [~, datafile{1}.infos, datafile{1}.data] = pspm_load_data(testCase.fn1);
    ...
    methods
        ...
        function [from, to, exp_val, warningID, testmsg] = markertest_1(testCase, markerchan)
            ...
            [~, exp_val.infos, exp_val.data] = pspm_load_data(testCase.fn1,0);
            from = -20;
            to = 20;
        ...
        function [from, to, exp_val, warningID, testmsg] = markertest_2(testCase, markerchan)
            ...
            warningID = 'none';
            [~, exp_val.infos, exp_val.data, filestruct] = pspm_load_data(testCase.fn1,0);
