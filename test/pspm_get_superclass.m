    ...
    function init(this)
      ...
      for k = 1:numel(this.testcases)
        for m = 1:numel(this.testcases{k}.import)
          this.testcases{k}.import{m}.typeno = ...
            find(strcmpi(this.testcases{k}.import{m}.type, {settings.chantypes.type}));
        end
      end
    end
  end
      ...
      for k = 1:numel(this.testcases)
        ...
        for blk = 1:blkno
          ...
          for m = 1:numel(this.testcases{k}.import)
            ...
            this.verifyTrue(...
              isnumeric(import{blk}{m}.data) || islogical(import{blk}{m}.data), ...
            ...
            if strcmpi(settings.chantypes(this.testcases{k}.import{m}.typeno).data, 'wave') || ...
              ...
              this.verifyTrue(...
                numel(import{blk}{m}.data) / import{blk}{m}.sr <= 3600, ...
            ...
            elseif strcmpi(settings.chantypes(this.testcases{k}.import{m}.typeno).data, 'events') && ...
                (strcmpi(import{blk}{m}.marker, 'timestamps') || ...
                strcmpi(import{blk}{m}.marker, 'timestamp'))
              this.verifyTrue(10^-6 <= import{blk}{m}.sr && ...
                import{blk}{m}.sr <= 1, ...
