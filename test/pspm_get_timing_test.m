...
% (C) 2013 Linus Rüttimann (University of Zurich)
    ...
    methods (Test)       
        ...
        function case_onsets(this)
            ...
            markerinfo.name ={'Condition A','Condition A','Condition B','Condition A','Condition A','Condition B','Condition B','Condition B','Condition A','Condition A','Condition B','Condition A','Condition A','Condition B','Condition A','Condition B','Condition B','Condition A','Condition A','Condition A','Condition A','Condition B','Condition A','Condition A','Condition A','Condition A','Condition A','Condition B','Condition A','Condition B','Condition A','Condition B','Condition B','Condition B','Condition B','Condition A','Condition A','Condition B','Condition A','Condition B','Condition B','Condition B','Condition A','Condition A','Condition B'};
            markervalue = [1 2];
