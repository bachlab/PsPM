function [sts, import, sourceinfo] = scr_get_vario(datafile, import)
% scr_get_vario is the main function for import of VarioPort files
% FORMAT: [sts, import, sourceinfo] = scr_get_acq(datafile, import);
%
...
% $Id: scr_get_vario.m 701 2015-01-22 14:36:13Z tmoser $
% $Rev: 701 $
...
for k = 1:numel(import)
    if ~strcmpi(import{k}.type, 'marker')
        ...
        if import{k}.channel > 0
            ...
            chan = scr_find_channel({vario.channel.name}, import{k}.type);
