...
| model.centering | [optional] If set to 0 the function would not perform the mean centering of the convolved X data. For example, to invert SPS model, set centering to 0. Default: 1. || options | See following fields. |
