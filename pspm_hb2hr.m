function sts = pspm_hb2hr(fn, sr, chan, options)
% pspm_hb2hr transforms heart beat data into an interpolated heart rate
% signal and adds this as an additional channel to the data file
% 
% sts = pspm_hb2hr(fn, sr, chan)
%       fn: data file name
...
% $Id: pspm_hb2hr.m 701 2015-01-22 14:36:13Z tmoser $
% $Rev: 701 $
