function [sts, import, sourceinfo] = scr_get_mat(datafile, import)
% scr_get_mat is the main function for import of matlab files
% FORMAT: [sts, import, sourceinfo] = scr_get_mat(datafile, import);
...
% $Id: scr_get_mat.m 701 2015-01-22 14:36:13Z tmoser $
% $Rev: 701 $
...
% v003 drb 11.02.2011 comply with new scr_import requirements
