function [sts, import, sourceinfo] = scr_get_obs(datafile, import)
% scr_get_obs is the main function for import of text-exported Noldus
% Observer XT compatible files. At the current state the function is only
% assured to work with the output files of Vsrrp98.
%
% FORMAT: [sts, import, sourceinfo] = scr_get_obs(datafile, import);
%__________________________________________________________________________
% PsPM 3.0
% (C) 2013-2015 Linus Rüttimann (University of Zurich)

% $Id: scr_get_obs.m 701 2015-01-22 14:36:13Z tmoser $
% $Rev: 701 $
...
for k = 1:numel(import)
    ...
    elseif strcmpi(import{k}.type, 'marker')
        chan = scr_find_channel(obs.channel_names, {'sync'});
        ...
        chan = scr_find_channel(obs.channel_names, import{k}.type);
