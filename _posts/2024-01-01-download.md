...
1. <a href="https://github.com/bachlab/PsPM/releases/download/v7.0.0/PsPM_installer.m" download>Download the installer into an arbitrary directory</a>
2. Open Matlab.
...
2. Click on "code" and copy the clone URL. Use https for an anonymous clone. For ssh, you need a github account with a linked ssh key pair.
3. Open a terminal.
4. Navigate to a folder of your choice.
5. Type "git clone <URL>", inserting the URL you copied in step 2.
