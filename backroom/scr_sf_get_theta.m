function theta = scr_sf_get_theta(scr, sr, esr, fn, closewindow)
% create parameters for f_SF, given some data scr
% 
% FORMAT
% function theta = scr_sf_get_theta(scr, sr, fn, closewindow)
% 
%   theta:  parameters
...
% $Id: scr_sf_get_theta.m 701 2015-01-22 14:36:13Z tmoser $
% $Rev: 701 $
