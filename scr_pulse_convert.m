...
% FORMAT:
% wavedata=scr_pulse_convert(pulsedata, resamplingrate, samplingrate)
...
% $Id: scr_pulse_convert.m 701 2015-01-22 14:36:13Z tmoser $   
% $Rev: 701 $
...
% convert data    
    ...
    if samplingrate < resamplingrate
        ...
        [sts, wavedata] = scr_prepdata(wavedata, filt);
    end;
end;
