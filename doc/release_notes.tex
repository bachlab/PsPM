...
section.
\item Add the posibility to select the flank in the \texttt{Import} module
of the GUI of PsPM.
\end{itemize}
...
\end{itemize}
\item Fix bug in \texttt{pspm_trim} which was wrongly defining the starting 
...
\subsection*{New Features}
\begin{itemize}
\item New DSV (delimiter separated values) option for imports as well as a CSV import function
\end{itemize}
