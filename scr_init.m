...
% get pspm version
% -------------------------------------------------------------------------
[foo, pspm_version] = scr_version('check');
...
defaults.glm(4) = ... % GLM for PS (fear-conditioning)
    struct('modality', 'ps', ...
    'modelspec', 'ps_fc', ...
    'cbf', struct('fhandle', @scr_bf_psrf_fc, 'args', 1), ...
...
defaults.glm(5) = ... % GLM for RA (evoked)
    struct('modality', 'ra', ...
    'modelspec', 'ra_e', ...
    'cbf', struct('fhandle', @scr_bf_rarf_e, 'args', 1), ...
...
defaults.glm(7) = ... % GLM for RP (evoked)
    struct('modality', 'rp', ...
    'modelspec', 'rp_e', ...
    'cbf', struct('fhandle', @scr_bf_rprf_fc, 'args', 1), ...
    'filter', struct('lpfreq', 1, 'lporder', 1,  ...
    'hpfreq', 0.01, 'hporder', 1, 'down', 10, ...
    'direction', 'uni'), ...
    'default', 0);
...
defaults.glm(8) = ... % GLM for RFR (evoked)
    struct('modality', 'rfr', ...
    'modelspec', 'rfr_e', ...
    'cbf', struct('fhandle', @scr_bf_rfrrf_fc, 'args', 1), ...
    'filter', struct('lpfreq', 1, 'lporder', 1,  ...
