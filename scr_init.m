...
defaults.chantypes =  ...
    struct('type', {'scr', 'ecg', 'hr', 'hb', 'hp', 'resp', 'rp', 'rr', 'pupil', 'marker', 'custom'}, ...
    'description', {'SCR', 'ECG', 'Heart Rate', 'Heart Beat', 'Heart Period', 'Respiration', 'Respiration Period', 'Respiration Rate', 'Pupil size', 'Marker', 'Custom'}, ...
