...
helptext_import_acq = ['Biopac Acknowledge (.acq) files can be imported with this feature. ',...
                      ...
                      'imported with the classic method.'];
helptext_import_acq_python = ['Biopac Acknowledge (.acq) files can be imported with this feature. ',...
                      'Any version of acq files is supported with the Python method.', ...
