function split_sessions = pspm_cfg_split_sessions
    ...
    'with a suffix ''_sn'', and the session number. You can choose only one datafile and only ' ...
    'one missing epoch file to add. You can choose a marker channel if several were recorded.']};
