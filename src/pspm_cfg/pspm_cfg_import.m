...
for datatype_i=1:length(fileoptions)
  ...
  acq_import_classic.help    = {['Import Biopac Acqknowledge (ACQ) files with the python. ',...
  ...
  python_path_help_text = [{'Specify the path of python installation in the computer. '}; ...
                          {'Please make sure the Python package **bioread** has been installed. '}; ...
                          {''};...
  ...
  acq_import_python.help      = {['Import Biopac Acqknowledge (ACQ) files with the python. ',...
