...
%% Specific items
% screen_size_px      = cfg_entry;                  % screen_size_px no longer in pspm_pupil_correct_eyelink 
...
% screen_size_mm      = cfg_entry;                  % screen_size_mm no longer in pspm_pupil_correct_eyelink 
...
pupil_correct.val  = {datafile, channel, channel_action,mode};%, screen_size_px, screen_size_mm, };
