...
channels.num                = [1 Inf];
channels.val                = {'pupil'};
channels.help               = {['Enter a list of pupil channels ', ...
    '(numbers or names)', ...
    'to work on. ', ...
    'Default is to select the first existing option from the following precedence order: combined/non-lateralised/best-lateralised/last.']};
