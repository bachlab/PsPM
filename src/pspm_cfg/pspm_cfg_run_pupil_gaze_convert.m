...
elseif (isfield(job.conversion, 'distance2sps'))
  ...
  [sts, out] = pspm_convert_pupil_gaze_distance(fn, 'sps', args.from, args.height, args.width, args.screen_distance, options);

elseif (isfield(job.conversion, 'distance2degree'))
  args = job.conversion.distance2degree;
  [ sts, out ] = pspm_convert_pupil_gaze_distance(fn, 'degree', args.from, args.height, args.width, args.screen_distance, options);
end
