...
for i=1:numel(job.conversions)
  ...
  elseif (isfield(conversion, 'distance2sps'))
    ...
    [sts, out] = pspm_pupil_gaze_distance2sps(fn, args.from, args.height, args.width, args.screen_distance)

  elseif (isfield(conversion, 'distance2degree'))
    args = conversion.distance2degree;
    [ sts, out ] = pspm_pupil_gaze_distance2degree(fn, args.from, args.height, args.width, args.screen_distance)
  end 
end
