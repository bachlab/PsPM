...
lasttrialfiltering.help = {['Define a cutoff value for using parameter ',...
	'estimates from the last trial. If there fewer data after the end ',...
	'of then last trial in a session than this cutoff value (in s), ',...
	'then estimated parameters from this trial will be assumed ',...
	'inestimable and set to NaN after the inversion. This value can be ',...
	'set as inf to always retain parameters from the last trial. The ',...
	'default value for this field is 7 s (corresponding to the time ',...
	'at which the canonical SCRF has decayed to around 80% of its peak).']};
