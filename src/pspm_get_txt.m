...
%             to delimit data columns. To be used it should be specified on the
%             first import cell, e.g.: import{1}.delimiter == ','
...
%             To be used it should be specified on the first import cell, e.g.: 
%             import{1}.header_lines == 3. Default: 1.
%   .channel_names_line:
%             A numeric value corresponding to the line number where the
%             channel names are specified. To be used it should be specified on
%             the first import cell, e.g. import{1}.channel_names_line == 2
%             Default: 1. 
%   .exclude_columns:
%             A numeric value corresponding to the number of columns to exclude
%             starting from the left. To be used it should be specified on the
%             first import cell, e.g. import{1}.exclude_columns == 2. Default: 0
% ● Introduced In
%   PsPM 3.0
% ● Written By
