...
% reference:    'marker':   from and to are set in seconds with respect 
%                           to the first and last scanner/marker pulse
%               'file':     from and to are set in seconds with respect to start of 
%                           datafile
%               a 2-element vector: from and to are set in seconds with respect to 
%                           the two markers defined here
%               a 2-elemtn cell-array: from and to are set in seconds with respect 
%                           to the first two markers having the value held in the cell array
%
% options:  options.overwrite:          overwrite existing files by default
%           options.marker_chan_num:    marker channel number
%                                       if undefined or 0, first marker channel is used
%           options.drop_offset_markers:
%                                       if offsets are set in the reference, 
%                                       you might be interested in only the data, 
%                                       but not in the additional markers which are 
%                                       within the offset. 
%                                       Therefore set this option to 1 to drop
%                                       markers which lie in the offset.
%                                       this is for event channels only. 
%                                       Default: 0.
%           options.verbose:            Tell the function to display information about 
...
%
% PsPM 5.1
% Updated in 2021: Dadi Zhao (Wellcome Centre for Human Neuroimaging)
