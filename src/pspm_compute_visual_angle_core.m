function [lat, lon, lat_range, lon_range] = pspm_compute_visual_angle_core(x_data, y_data, width, height, distance)
% ● Description
...
%   the screen.
% ● Format
%   [lat, lon, lat_range, lon_range] = pspm_compute_visual_angle_core(x_data, y_data, width, height, distance)
% ● Arguments
%           x_data: X axis data
%           y_data: y axis data
