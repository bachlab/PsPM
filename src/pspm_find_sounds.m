...
% ● Description
%   pspm_find_sounds finds and if required analyzes sound events in a pspm file. A sound
%   is accepted as event if it is longer than 10 ms and events are recognized as different
%   if they are at least 50 ms appart.
% ● Format
