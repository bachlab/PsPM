...
function flag = get_chans_to_load_for_pupil(data, flag, best_eye)
    ...
    pupil_channels = cell2mat(cellfun(...
        @(chantype) startsWith(chantype, 'pupil'),...
        chantype_list,...
        'uni',...
        false...
    ));
    preprocessed_channels = cell2mat(cellfun(...
        @(chantype) endsWith(chantype, '_pp'),...
        chantype_list,...
        'uni',...
        false...
    ));
    combined_channels = cell2mat(cellfun(...
        @(chantype) contains(chantype, '_lr_') && endsWith(chantype, '_pp'),...
        chantype_list,...
        'uni',...
        false...
    ));
    besteye_channels = cell2mat(cellfun(...
        @(chantype) endsWith(chantype, ['_' best_eye]) || contains(chantype, ['_' best_eye '_']),...
        chantype_list,...
        'uni',...
        false...
    ));
