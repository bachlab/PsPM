function pspm_init
  ...
  'data', 'wave');
  % Gaze X
  defaults.chantypes(end+1) = struct('type', 'gaze_x', ...
  'description', 'Gaze x', ...
  'import', @pspm_get_gaze_x, ...
  'data', 'wave');
  defaults.chantypes(end+1) = struct('type', 'gaze_x_c', ...
  'description', 'Gaze x combined', ...
  'import', @pspm_get_gaze_x_c, ...
  'data', 'wave');
  defaults.chantypes(end+1) = struct('type', 'gaze_x_l',  'description', 'Gaze x left',     'import', @pspm_get_gaze_x_l, 'data', 'wave');
  defaults.chantypes(end+1) = struct('type', 'gaze_x_r',  'description', 'Gaze x right',    'import', @pspm_get_gaze_x_r, 'data', 'wave');
  % Gaze Y
  defaults.chantypes(end+1) = struct('type', 'gaze_y',    'description', 'Gaze y',          'import', @pspm_get_gaze_y,   'data', 'wave');
  defaults.chantypes(end+1) = struct('type', 'gaze_y_c',  'description', 'Gaze y combined', 'import', @pspm_get_gaze_y_c, 'data', 'wave');
  defaults.chantypes(end+1) = struct('type', 'gaze_y_l',  'description', 'Gaze y left',     'import', @pspm_get_gaze_y_l, 'data', 'wave');
  defaults.chantypes(end+1) = struct('type', 'gaze_y_r',  'description', 'Gaze y right',    'import', @pspm_get_gaze_y_r, 'data', 'wave');
  % Pupil
  defaults.chantypes(end+1) = struct('type', 'pupil', 'description', 'Pupil', 'import', @pspm_get_pupil, 'data', 'wave');
  defaults.chantypes(end+1) = ...
  struct('type', 'pupil_c', ...
