...
defaults.chantypes(end+1) = ...
  ...
  'description', 'Gaze x bilateral', ...
  'import', @pspm_get_gaze_x_b, ...
  'data', 'wave');
defaults.chantypes(end+1) = ...
...
% Gaze X preprocessed
defaults.chantypes(end+1) = ...
  struct('type', 'gaze_x_pp', ...
  'description', 'Gaze x preprocessed', ...
  'import', @none, ...
  'data', 'wave');
defaults.chantypes(end+1) = ...
  struct('type', 'gaze_x_pp_b', ...
  'description', 'Gaze x preprocessed bilateral', ...
  'import', @none, ...
  'data', 'wave');
defaults.chantypes(end+1) = ...
  struct('type', 'gaze_x_pp_l', ...
  'description', 'Gaze x preprocessed left', ...
  'import', @none, ...
  'data', 'wave');
defaults.chantypes(end+1) = ...
  struct('type', 'gaze_x_pp_r', ...
  'description', 'Gaze x preprocessed right', ...
  'import', @none, ...
  'data', 'wave');
...
defaults.chantypes(end+1) = ...
  ...
  'description', 'Gaze y bilateral', ...
  'import', @pspm_get_gaze_y_b, ...
  'data', 'wave');
defaults.chantypes(end+1) = ...
...
% Gaze Y preprocessed
defaults.chantypes(end+1) = ...
  struct('type', 'gaze_y_pp', ...
  'description', 'Gaze y preprocessed', ...
  'import', @none, ...
  'data', 'wave');
defaults.chantypes(end+1) = ...
  struct('type', 'gaze_y_pp_b', ...
  'description', 'Gaze y preprocessed bilateral', ...
  'import', @none, ...
  'data', 'wave');
defaults.chantypes(end+1) = ...
  struct('type', 'gaze_y_pp_l', ...
  'description', 'Gaze y preprocessed left', ...
  'import', @none, ...
  'data', 'wave');
defaults.chantypes(end+1) = ...
  struct('type', 'gaze_y_pp_r', ...
  'description', 'Gaze y preprocessed right', ...
  'import', @none, ...
  'data', 'wave');
...
defaults.chantypes(end+1) = ...
  ...
  'data', 'wave');
defaults.chantypes(end+1) = ...
  struct('type', 'pupil_pp_b', ...
  'description', 'Pupil preprocessed bilateral', ...
  'import', @none, ...
  'data', 'wave');
defaults.chantypes(end+1) = ...
...
defaults.chantypes(end+1) = ...
  ...
  'data', 'wave');
defaults.chantypes(end+1) = ...
  struct('type', 'pupil_missing_b', ...
  'description', 'Pupil data missing/interpolated bilateral', ...
  'import', @none, ...
  'data', 'wave');
defaults.chantypes(end+1) = ...
...
defaults.chantypes(end+1) = ...
  struct('type', 'sps_b', ...
  'description', 'Scanpath speed from bilateral gaze channels', ...
  'import', @none, ...
  'data', 'wave');
