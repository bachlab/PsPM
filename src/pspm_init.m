...
defaults.chantypes(end+1) = ...
  ...
  'data', 'wave');
defaults.chantypes(end+1) = ...
  struct('type', 'gaze_pp_x_b', ...
  'description', 'Gaze preprocessed x bilateral', ...
  'import', @none, ...
  'data', 'wave');
defaults.chantypes(end+1) = ...
...
defaults.chantypes(end+1) = ...
  ...
  'data', 'wave');
defaults.chantypes(end+1) = ...
  struct('type', 'gaze_pp_y_b', ...
  'description', 'Gaze preprocessed y bilateral', ...
  'import', @none, ...
  'data', 'wave');
defaults.chantypes(end+1) = ...
...
defaults.lateral.simplified = {'l', 'r', 'b'};
