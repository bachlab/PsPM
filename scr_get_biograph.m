function [sts, import, sourceinfo] = scr_get_biograph(datafile, import)
% scr_get_biograph is the main function for import of text-exported
% BioGraph Infiniti files
% FORMAT: [sts, import, sourceinfo] = scr_get_biograph(datafile, import);
%
%__________________________________________________________________________
% PsPM 3.0
% (C) 2008-2015 Dominik R Bach (Wellcome Trust Centre for Neuroimaging)

% $Id: scr_get_biograph.m 701 2015-01-22 14:36:13Z tmoser $
% $Rev: 701 $
