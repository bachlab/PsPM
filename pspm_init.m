...
defaults.import.datatypes(19) = ...
    ...
    'If two eyes were recorded channels will be (Channel id 1-6): ', ...
    'Pupil (diameter) L, Pupil R, x L, y L, x R, y R. ', ...
    'If one eye was recorded, channels will be (Channel id 1-3): ', ...
    'Pupil (diameter), x, y.']);
