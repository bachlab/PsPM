function newdatafile = scr_pp(varargin)
% scr_pp contains various preprocessing utilities for reducing noise in the
% data. 
...
% $Id: scr_pp.m 701 2015-01-22 14:36:13Z tmoser $   
% $Rev: 701 $
