function [sts, import, sourceinfo] = scr_get_cnt(datafile, import)
% scr_get_cnt is the main function for import of NeuroScan cnt files
% FORMAT: [sts, import, sourceinfo] = scr_get_cnt(datafile, import);
% this function uses fieldtrip fileio functions
%__________________________________________________________________________
% PsPM 3.0
% (C) 2008-2015 Dominik R Bach (Wellcome Trust Centre for Neuroimaging)

% $Id: scr_get_cnt.m 701 2015-01-22 14:36:13Z tmoser $
% $Rev: 701 $
