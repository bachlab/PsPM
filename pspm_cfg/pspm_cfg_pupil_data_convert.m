function [pp_convert] = pspm_cfg_pupil_data_convert
% function [pp_convert] = pspm_cfg_pupil_data_convert(job)
%
...
pp_convert.prog   = @pspm_cfg_run_pupil_data_convert;
pp_convert.help   = {['Provides conversion of pupil data recorded in arbitrary ', ...
    'units into a metric unit (arbitrary units to millimeter).  The exact ', ...
    'conversion depends on the eyetracking mode and on the distance of the ', ...
    'participant to the screen (see Korn & Bach, 2016, J Vis, ', ...
    'Hayes & Petrov, 2015, Behavior Research Methods). The default values ', ...
    'here are for the ''ellipse mode'' and a distance of 70 cm. ', ...
