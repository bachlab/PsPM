function [pupil_pp] = pspm_cfg_pupil_preprocess(job)
    ...
    chancomb_def.values = {'none', 'pupil_l', 'pupil_r', 'pupil_l_pp', 'pupil_r_pp'};
    chancomb_def.labels = {'No combining', 'Left pupil', 'Right pupil', 'Left preprocessed pupil', 'Right preprocessed pupil'};
