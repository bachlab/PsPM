function [sts, import, sourceinfo] = scr_get_acqmat(datafile, import)
% scr_get_acqmat is the main function for import of exported 
% biopac/acknowledge files, version 4.0 or higher (tested on 4.2.0)
% FORMAT: [sts, import, sourceinfo] = scr_get_acqmat(datafile, import);
%
...
% $Id: scr_get_acqmat.m 701 2015-01-22 14:36:13Z tmoser $
% $Rev: 701 $
...
for k = 1:numel(import)
    ...
    if import{k}.channel > 0
        ...
        chan = scr_find_channel(cellstr(inputdata.labels), import{k}.type);
