function [sts, epochfile] = scr_find_data_epochs(datafile, chan_id, options)
% scr_find_data_epochs tries to find epochs of non-zero values in the data
% of a channel. It then writes it to a file depending on the input and
% returns the location of that file.
%
% FORMAT: 
%   [sts, epochfile] = scr_find_data_epochs(datafile, chan_id, options)
% 
% ARGUMENTS:
