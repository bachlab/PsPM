function scr_con2(modelfile, outfile, con, connames, options)
% scr_con2 is a function to set up second level contrasts. Currently, one- 
...
%           to compute these with scr_con1 in one call)
...
% $Id: scr_con2.m 701 2015-01-22 14:36:13Z tmoser $
% $Rev: 701 $ 
...
function [sts, foo] = loadmodel(modelfile, datatype)
    [sts, foo] = scr_load1(modelfile, 'con', datatype);
    if isempty(foo)
