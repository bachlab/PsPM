...
freq.strtype = 'r';
freq.num     = [1 1];
freq.check   = @scr_cfg_check_artefact_rm_freq;
...
artefact_rm.prog = @scr_cfg_run_artefact_rm;
artefact_rm.vout = @scr_cfg_vout_artefact;
...
function [sts, val] =  scr_cfg_check_artefact_rm_freq(val)
sts = [];
if val < 20
...
function vout = scr_cfg_vout_artefact(job)
vout = cfg_dep;
