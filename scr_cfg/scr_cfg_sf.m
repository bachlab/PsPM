...
sf.prog = @scr_cfg_run_sf;
sf.vout = @scr_cfg_vout_sf;
sf.help = {['This suite of models is designed for analysing spontaneous fluctuations (SF) in skin conductance ' ...
    ...
    'typically last 60 s and should at least be 15 s long. SCRalyze implements 3 different models: '], '', ...
    ...
    'Bach & Staib (submitted) (MP)'};

function vout = scr_cfg_vout_sf(job)
vout = cfg_dep;
