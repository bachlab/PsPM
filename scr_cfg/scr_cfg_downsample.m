...
newfreq.strtype = 'r';
newfreq.num     = [1 1];
newfreq.check   = @scr_cfg_checkdownsample_newfreq;
...
downsample.prog = @scr_cfg_run_downsample;
downsample.vout = @scr_cfg_vout_downsample;
downsample.help = {['This function downsamples individual channels in an SCRalyze file to a required sampling ' ...
...
function [sts, val] =  scr_cfg_checkdownsample_newfreq(val)
sts = [];
if val < 10
...
function vout = scr_cfg_vout_downsample(job)
