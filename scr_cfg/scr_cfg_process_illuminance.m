...
proc_illuminance.help = {['Transform an illuminance time series into ', ... 
    ...
    'illuminance to steady-state pupil size.'], 'References', ...
    'Korn, Bach (2016) Journal of Vision'};

function vout = scr_cfg_vout_proc_illuminance(job)
vout = cfg_dep;
