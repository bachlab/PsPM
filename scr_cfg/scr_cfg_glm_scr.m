...
%% Executable Branch
glm_scr       = cfg_exbranch;
glm_scr.name  = 'GLM';
glm_scr.tag   = 'glm';
glm_scr.val   = {modelfile, outdir, chan, timeunits, session_rep, bf, norm, filter, overwrite};
glm_scr.prog  = @scr_cfg_run_glm_scr;
glm_scr.vout  = @scr_cfg_vout_glm_scr;
glm_scr.help  = {['General linear convolution models (GLM) are powerful for analysing evoked responses that ' ...
...
function vout = scr_cfg_vout_glm_scr(job)
vout = cfg_dep;
