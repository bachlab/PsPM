function markerinfo = scr_cfg_get_markerinfo
...
markerinfo.prog = @scr_cfg_run_get_markerinfo;
markerinfo.vout = @scr_cfg_vout_get_markerinfo;
markerinfo.help = {['']};

function vout = scr_cfg_vout_get_markerinfo(job)
vout = cfg_dep;
